...
```{r}
#survey_main$gender	marital_status	education	religion	caste
#df_pivot <- survey_main %>% pivot_wider(names_from = gender, values_from = Value, values_fill = 0)
#table(survey_main$gender)
pivot_wider(survey_main,survey_main$gender)
```
